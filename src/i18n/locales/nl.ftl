...
start =
    <b>Hallo! 👋 Ik ben MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Snel & Gemakkelijk Citeren! ✨</b>
...
donate-info =
    <b>Steun de Ontwikkeling van MEHMMETT_Quotely_bot! ☕</b>
    ...
    Elke bijdrage helpt om MEHMMETT_Quotely_bot beter te maken voor iedereen! 💜
donate-title = Steun { $botUsername }
donate-description = Help de magie voort te zetten ✨
donate-successful =
    <b>Bedankt voor uw steun! 💜</b>
    Je helpt MEHMMETT_Quotely_bot nog beter te maken!
...
guest-hint_short = Hoe MEHMMETT_Quotely werkt in gastmodus
guest-need_reply =
    <b>Bijna klaar! 🪄</b>
...
guest-open_in_pm = Openen in MEHMMETT_Quotely →
