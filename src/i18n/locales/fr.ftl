...
start =
    <b>Salut! 👋 Je suis MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Citations Rapides & Faciles! ✨</b>
...
donate-info =
    <b>Soutenez le Développement de MEHMMETT_Quotely_bot ! ☕</b>
    ...
    Chaque contribution aide à améliorer MEHMMETT_Quotely_bot pour tout le monde ! 💜
donate-title = Soutenir { $botUsername }
donate-description = Aidez à maintenir la magie en vie ✨
donate-successful =
    <b>Merci pour votre soutien ! 💜</b>
    Vous contribuez à rendre MEHMMETT_Quotely_bot encore meilleur !
...
guest-hint =
    <b>MEHMMETT_Quotely — mode invité 💬</b>
...
guest-hint_short = Comment MEHMMETT_Quotely fonctionne en mode invité
guest-need_reply =
    <b>Presque ! 🪄</b>
...
guest-open_in_pm = Ouvrir dans MEHMMETT_Quotely →
