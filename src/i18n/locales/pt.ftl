...
start =
    <b>Olá! 👋 Eu sou o MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ Guia Rápido do MEHMMETT_Quotely_bot</b>
    ...
    • Blog: @LyBlog
    • GitHub: github.com/MadebyMehmmeTT/MEHMMETT_Quotely
...
donate-info =
    <b>Suporte ao Desenvolvimento do MEHMMETT_Quotely_bot! ☕</b>
    ...
    Toda contribuição ajuda a tornar o MEHMMETT_Quotely_bot melhor para todos! 💜
donate-title = Suporte { $botUsername }
donate-description = Ajude a manter a magia acontecendo ✨
donate-successful =
    <b>Obrigado pelo seu apoio! 💜</b>
    Você está ajudando a tornar o MEHMMETT_Quotely_bot ainda melhor!
...
guest-hint =
    <b>MEHMMETT_Quotely — modo convidado 💬</b>
...
guest-hint_short = Como o MEHMMETT_Quotely funciona no modo convidado
guest-need_reply =
    <b>Quase lá! 🪄</b>
...
guest-open_in_pm = Abrir no MEHMMETT_Quotely →
