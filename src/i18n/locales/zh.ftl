...
help =
    <b>✨ MEHMMETT_Quotely_bot：快速 & 简单的引言！✨</b>
...
top-open = 查看顶级引文
donate-info =
    <b>支持 MEHMMETT_Quotely_bot 的发展！☕</b>
    ...
    每一份贡献都在帮助让 MEHMMETT_Quotely_bot 变得更好！💜
donate-title = 支持 { $botUsername }
donate-description = 帮助保持魔法继续 ✨
donate-successful =
    <b>感谢您的支持！💜</b>
    您正在帮助让 MEHMMETT_Quotely_bot 变得更好！
...
guest-hint =
    ...
    想体验完整功能，请在私聊中打开我。
guest-hint_short = MEHMMETT_Quotely 在访客模式下如何工作
guest-need_reply =
    <b>就差一步了！🪄</b>
...
guest-empty_query =
    <b>MEHMMETT_Quotely 在此 💜</b>

    回复此聊天中的任意消息并提及 <code>@{ $username }</code>，即可将其变成引用贴纸。

    点击下方在私聊中打开我，获取完整功能。
guest-open_in_pm = 在 MEHMMETT_Quotely 中打开 →
