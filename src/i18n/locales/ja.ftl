...
start =
    <b>こんにちは！ 👋 私はMEHMMETT_Quotely_botです</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: 簡単かつ迅速な引用！ ✨</b>
...
top-open = トップ引用を見る
donate-info =
    <b>MEHMMETT_Quotely_botの開発をサポートしよう！☕</b>
    ...
    すべての貢献はMEHMMETT_Quotely_botをより良くする手助けになります！💜
donate-title = { $botUsername }をサポート
donate-description = 魔法を持続させる手助けを ✨
donate-successful =
    <b>サポートありがとうございます！💜</b>
    MEHMMETT_Quotely_botのさらなる進化を支援いただけて嬉しいです！
...
guest-hint_short = ゲストモードでのMEHMMETT_Quotelyの使い方
guest-need_reply =
    <b>あと少し！🪄</b>
