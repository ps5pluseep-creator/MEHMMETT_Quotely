...
start =
    <b>Ciao! 👋 Sono MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ Guida Rapida di MEHMMETT_Quotely_bot</b>
...
donate-info =
    <b>Supporta lo sviluppo di MEHMMETT_Quotely_bot! ☕</b>
    ...
    Ogni contributo aiuta a migliorare MEHMMETT_Quotely_bot per tutti! 💜
donate-title = Supporta { $botUsername }
donate-description = Aiuta a mantenere la magia ✨
donate-successful =
    <b>Grazie per il tuo supporto! 💜</b>
    Stai aiutando a rendere MEHMMETT_Quotely_bot ancora migliore!
...
guest-hint =
    <b>MEHMMETT_Quotely — modalità ospite 💬</b>
...
guest-hint_short = Come funziona MEHMMETT_Quotely in modalità ospite
guest-need_reply =
    <b>Ci siamo quasi! 🪄</b>
...
guest-open_in_pm = Apri in MEHMMETT_Quotely →
