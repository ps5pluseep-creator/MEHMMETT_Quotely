...
start =
    <b>Hai! 👋 Saya MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Kutipan Cepat & Mudah! ✨</b>
...
donate-info =
    <b>Dukung Pengembangan MEHMMETT_Quotely_bot! ☕</b>
    ...
    Setiap kontribusi membantu membuat MEHMMETT_Quotely_bot lebih baik untuk semua! 💜
...
donate-successful =
    ...
    Anda telah membantu membuat MEHMMETT_Quotely_bot menjadi lebih baik!
...
guest-hint =
    <b>MEHMMETT_Quotely — mode tamu 💬</b>
...
guest-hint_short = Cara kerja MEHMMETT_Quotely dalam mode tamu
guest-need_reply =
    <b>Hampir selesai! 🪄</b>
...
guest-open_in_pm = Buka di MEHMMETT_Quotely →
