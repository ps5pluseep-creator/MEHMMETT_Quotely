...
start =
    <b>Привет! 👋 Я MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Быстрые и Лёгкие Цитаты! ✨</b>
...
donate-info =
    <b>Поддержите развитие MEHMMETT_Quotely_bot! ☕</b>
    ...
    Каждый вклад помогает сделать MEHMMETT_Quotely_bot лучше для всех! 💜
donate-title = Поддержать { $botUsername }
donate-description = Помогите сохранять волшебство ✨
donate-successful =
    <b>Спасибо за вашу поддержку! 💜</b>
    Вы помогаете сделать MEHMMETT_Quotely_bot еще лучше!
...
guest-hint =
    <b>MEHMMETT_Quotely — гостевой режим 💬</b>
...
guest-hint_short = Как работает MEHMMETT_Quotely в гостевом режиме
guest-need_reply =
    <b>Почти готово! 🪄</b>
...
guest-open_in_pm = Открыть MEHMMETT_Quotely →
