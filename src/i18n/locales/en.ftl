...
start =
    <b>Hi! 👋 I'm MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Quick & Easy Quotes! ✨</b>
...
donate-info =
    <b>Support MEHMMETT_Quotely_bot's Development! ☕</b>
    ...
    Every contribution helps make MEHMMETT_Quotely_bot better for everyone! 💜
donate-title = Support { $botUsername }
donate-description = Help keep the magic going ✨
donate-successful =
    <b>Thank you for your support! 💜</b>
    You're helping make MEHMMETT_Quotely_bot even better!
...
guest-hint =
    <b>MEHMMETT_Quotely — guest mode 💬</b>
...
guest-hint_short = How MEHMMETT_Quotely works in guest mode
guest-need_reply =
    <b>Almost there! 🪄</b>
...
guest-open_in_pm = Open in MEHMMETT_Quotely →
