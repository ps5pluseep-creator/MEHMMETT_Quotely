...
start =
    <b>¡Hola! 👋 Soy MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: ¡Citas Rápidas y Fáciles! ✨</b>
...
donate-info =
    <b>¡Apoya el desarrollo de MEHMMETT_Quotely_bot! ☕</b>
    ...
    ¡Cada contribución ayuda a mejorar MEHMMETT_Quotely_bot para todos! 💜
donate-title = Donar { $botUsername }
donate-description = Ayuda a mantener la magia ✨
donate-successful =
    <b>¡Gracias por tu apoyo! 💜</b>
    ¡Estás ayudando a mejorar MEHMMETT_Quotely_bot aún más!
...
guest-hint =
    <b>MEHMMETT_Quotely — modo invitado 💬</b>
...
guest-hint_short = Cómo funciona MEHMMETT_Quotely en modo invitado
guest-need_reply =
    <b>¡Casi listo! 🪄</b>
...
guest-open_in_pm = Abrir en MEHMMETT_Quotely →
