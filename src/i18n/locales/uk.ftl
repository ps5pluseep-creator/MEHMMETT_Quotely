...
start =
    <b>Привіт! 👋 Я MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Швидкі та Легкі Цитати! ✨</b>
...
donate-info =
    <b>Підтримайте розвиток MEHMMETT_Quotely_bot! ☕</b>
    ...
    Кожний внесок допомагає зробити MEHMMETT_Quotely_bot кращим для всіх! 💜
donate-title = Підтримати { $botUsername }
donate-description = Допоможіть зберегти магію ✨
donate-successful =
    <b>Дякуємо за вашу підтримку! 💜</b>
    Ви допомагаєте зробити MEHMMETT_Quotely_bot ще кращим!
...
guest-hint =
    <b>MEHMMETT_Quotely — гостьовий режим 💬</b>
...
guest-hint_short = Як працює MEHMMETT_Quotely у гостьовому режимі
guest-need_reply =
    <b>Майже! 🪄</b>
...
guest-open_in_pm = Відкрити MEHMMETT_Quotely →
