...
start =
    <b>Cześć! 👋 Jestem MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Szybkie i Łatwe Cytaty! ✨</b>
...
donate-info =
    <b>Wspieraj rozwój MEHMMETT_Quotely_bot! ☕</b>
    ...
    Każdy wkład pomaga sprawić, że MEHMMETT_Quotely_bot będzie lepszy dla wszystkich! 💜
donate-title = Wspieraj { $botUsername }
donate-description = Pomóż utrzymać magię ✨
donate-successful =
    <b>Dziękujemy za wsparcie! 💜</b>
    Pomagasz uczynić MEHMMETT_Quotely_bot jeszcze lepszym!
...
guest-hint =
    <b>MEHMMETT_Quotely — tryb gościa 💬</b>
...
guest-hint_short = Jak działa MEHMMETT_Quotely w trybie gościa
guest-need_reply =
    <b>Już prawie! 🪄</b>
...
guest-open_in_pm = Otwórz w MEHMMETT_Quotely →
