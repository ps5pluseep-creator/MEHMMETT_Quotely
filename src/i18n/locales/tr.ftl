...
start =
    <b>Merhaba! 👋 Ben MEHMMETT_Quotely_bot</b>
...
help =
    <b>✨ MEHMMETT_Quotely_bot: Hızlı & Kolay Alıntılar! ✨</b>
...
donate-info =
    <b>MEHMMETT_Quotely_bot'un Gelişimini Destekleyin! ☕</b>
    ...
    Her katkı, MEHMMETT_Quotely_bot'u herkes için daha iyi hale getirmeye yardımcı olur! 💜
...
donate-successful =
    ...
    MEHMMETT_Quotely_bot'u daha da iyi hale getiriyorsunuz!
...
guest-hint =
    <b>MEHMMETT_Quotely — misafir modu 💬</b>
...
guest-hint_short = MEHMMETT_Quotely misafir modunda nasıl çalışır
guest-need_reply =
    <b>Az kaldı! 🪄</b>
...
guest-open_in_pm = MEHMMETT_Quotely'de aç →
